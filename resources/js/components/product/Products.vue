                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input v-model="form.sales_price" type="text" name="sales_price"
                                class="form-control" :class="{ 'is-invalid': form.errors.has('sales_price') }">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input v-model="form.quantity" type="number" min="0" name="quantity"
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input v-model="form.strength" type="text" name="strength"
                                class="form-control" :class="{ 'is-invalid': form.errors.has('strength') }">
                            <has-error :form="form" field="strength"></has-error>
                          </div>
                        </div>
                      </div>
                      <!--  -->
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" v-model="form.type_id">
                              <option 
                                  v-for="(cat,index) in types" :key="index"
                                  :value="index"
                                  :selected="index == form.type_id">{{ cat }}</option>
                            </select>
    ...
    export default {
      components: {
        ...
        methods: {
          ...
          loadTypes(){
              axios.get("/api/type/list").then(({ data }) => (this.types = data.data));
          },
